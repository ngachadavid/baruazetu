...
export default function Submit() {
  return (
    <section className="w-full h-auto md:h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 px-4 md:px-10 py-10 flex flex-col justify-between h-full">
        {/* Top section */}
        <div className="bg-[#DDE6D5] text-black w-full md:w-[60%] flex flex-col justify-between gap-1 md:gap-2 px-2 md:px-6 py-2 md:py-8 text-[24px] md:text-[40px] tracking-[-0.075em] font-semibold">
